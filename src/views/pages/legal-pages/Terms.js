...
const Terms = ({ theme }) => {
  const initialValue = `<h4>Your Terms & Conditions goes here!</h4>`
  return (
    <div>
      <Card>
        <CardHeader>
            ...
            <Col lg="12" md="12" sm="12">
              <FormGroup>
                ...
                <Label for="searchText" className="mb-50">
                  Making changes to the terms & conditions will prompt your
                  users to agree to the new changes the next time they log in to
                  the system.
                </Label>
              </FormGroup>
            </Col>
