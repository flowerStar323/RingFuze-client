  ...
  return (
    <Card>
      <CardHeader className='flex-sm-row flex-column justify-content-sm-between justify-content-center align-items-sm-center align-items-start'>
        <CardTitle tag='h4'>Call History</CardTitle>
      ...
      <CardBody>
        <div className='d-flex align-items-center mb-2'>
          ...
          <div className='mr-2'>
            ...
            ></span>
            <span className='align-middle mr-75'>Converted</span>
          </div>
          <div>
            <span
              className='bullet bullet-sm bullet-bordered mr-50'
            ...
            ></span>
            <span className='align-middle'>Total Calls</span>
          </div>
        </div>
        <div className='recharts-wrapper'>
          <ResponsiveContainer>
            <AreaChart height={400} data={data}>
              ...
              <Area dataKey='completed' stackId='completed' stroke='0' fill='rgba(115, 103, 240, .5)' />
              <Area dataKey='converted' stackId='converted' stroke='0' fill='rgb(115, 103, 240)' />
              <Area dataKey='totalCalls' stackId='totalCalls' stroke='0' fill='rgba(115, 103, 240, .2)' />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </CardBody>
