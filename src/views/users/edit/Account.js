                ...
                <Table borderless striped responsive>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Listings</td>
                      <td>
                        <CustomInput type='checkbox' id='maintenance-1' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' id='maintenance-2' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' id='maintenance-3' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' id='maintenance-4' label='' />
                      </td>
                    </tr>
                    <tr>
                      <td>Projects</td>
                      <td>
                        <CustomInput type='checkbox' id='business-1' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' id='business-2' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' id='business-3' label='' />
                      </td>
                      <td>
                        <CustomInput type='checkbox' id='business-4' label='' disabled />
                      </td>
                    </tr>
                    <tr>
                      <td>Leads</td>
                      <td>
                        <CustomInput type='checkbox' id='publisher-1' label='' />
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>Settings</td>
                      <td>
                        <CustomInput type='checkbox' id='lead-1' label='' defaultChecked />
                      </td>
                      <td>
                        <CustomInput type='checkbox' id='lead-2' label='' />
                      </td>
                      <td>
