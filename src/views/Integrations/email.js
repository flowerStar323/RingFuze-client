...
import img_file from '../../assets/images/Integrations/Twilio.png'
        ...
        <CardBody>
          <div className='title-data'>
            <div className='title-icon'>
              <Mail size='25' className='primary' />
            </div>
            <div className='title-line'>
              <h4 className='mb-0'>Email Integrations</h4>
            </div>
          </div>
          <p className='mt-1'>
            Link your site up to your prefered email provider. Don't show your
          ...
          <Row className='align-items-center'>
            ...
            <Col sm='12' className='mb-1'>
              <FormGroup className='mb-0'>
                <Label for='nameVertical'>Send Grid API Key</Label>
                <Input type='text' name='sendkey' id='sendkey' placeholder='' />
              </FormGroup>
            </Col>
