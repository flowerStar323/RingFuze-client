    ...
    <Card className='plan-card border-primary'>
      ...
      <CardBody>
        <Badge className='text-capitalize' color='light-primary'>
          {selectedLead !== null ? selectedLead.currentPlan : 'Basic'}
        </Badge>
        <ul className='list-unstyled my-1'>
          <li>
            <span className='align-middle'>Basic: $99</span>
          </li>
          <li className='my-25'>
            <span className='align-middle'>Standard: $249</span>
          </li>
          <li>
            <span className='align-middle'>Enterprise: $499</span>
          </li>
        </ul>
